...
import { Github, Twitter, Linkedin, Heart, Mail, ArrowUp, ExternalLink } from "lucide-react"
...
export function Footer() {
  ...
  const socialLinks = [
    { icon: <Github className="h-5 w-5" />, url: "https://github.com", name: "GitHub" },
    ...
    { icon: <Mail className="h-5 w-5" />, url: "mailto:contact@example.com", name: "Email" }
  ]
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 md:mb-0">
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Professional portfolio and development platform built with 
              modern technologies to showcase your skills and projects.
            </p>
          </motion.div>

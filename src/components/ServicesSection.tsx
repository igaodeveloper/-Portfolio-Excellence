...
import { Code, Palette, ArrowUpRight, Lightbulb, LineChart, Users } from "lucide-react";
...
const services: Service[] = [
  {
    ...
    description: "Criação de aplicações web responsivas, performáticas e com foco na experiência do usuário.",
  },
  {
    icon: <Palette className="w-10 h-10" />,
    title: "UI/UX Design",
    description: "Design de interfaces modernas e intuitivas, prototipagem e criação de sistemas de design.",
  },
  {
    icon: <Lightbulb className="w-10 h-10" />,
    title: "Consultoria de Projetos",
    description: "Análise e otimização de projetos web com foco em usabilidade, performance e melhores práticas.",
  },
  {
    icon: <LineChart className="w-10 h-10" />,
    title: "SEO e Analytics",
    description: "Otimização para mecanismos de busca e implementação de soluções de análise de dados.",
  },
  {
    icon: <Users className="w-10 h-10" />,
    title: "Mentoria",
    description: "Orientação para desenvolvedores em início de carreira com foco em desenvolvimento front-end.",
  },
];

export default function ServicesSection() {
  return (
    <section id="services" className="py-20 px-6 bg-modern-dark relative overflow-hidden">
      {/* Background elements */}
      <motion.div 

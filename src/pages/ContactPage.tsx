        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-xl opacity-90">
              Tem uma pergunta, proposta ou projeto? Ou apenas quer dizer olá?
              Entre em contato!
            </p>
          </motion.div>
        </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Selecione o serviço que melhor descreve sua
                            necessidade.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
              ...
              <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Eu respondo a todas as mensagens dentro de 24 horas. Aguarde
                    meu retorno!
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  simples pode levar 2-3 semanas, enquanto projetos mais
                  complexos podem levar alguns meses. Sempre discutimos prazos
                  específicos durante o briefing inicial.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Os valores dependem da complexidade, funcionalidades e
                  tecnologias necessárias. Trabalhamos com orçamentos
                  transparentes, detalhando cada aspecto do projeto para que
                  você saiba exatamente pelo que está pagando.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Sim! Ofereço pacotes de manutenção mensal que incluem
                  atualizações, correções, backups e pequenas melhorias. Também
                  disponibilizo treinamento para que sua equipe possa gerenciar
                  conteúdos básicos.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Absolutamente! Trabalho com clientes de diversos países. A
                  comunicação é feita em português ou inglês, e as reuniões são
                  agendadas considerando os diferentes fusos horários.
                </p>
              </div>
            </div>

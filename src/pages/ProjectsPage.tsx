...
const projects = [
  {
    ...
    description: "Dashboard administrativo para gerenciamento de e-commerce com visualização de vendas, produtos e clientes.",
    image: "https://images.unsplash.com/photo-1531403009284-440f080d1e12?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    id: 2,
    title: "Blog NextJS",
    description: "Blog pessoal construído com Next.js, Tailwind CSS e MDX para criação de conteúdo técnico.",
  ...
  },
  {
    ...
    description: "Aplicativo móvel para gerenciamento de tarefas diárias, com sincronização em nuvem e notificações.",
    image: "https://images.unsplash.com/photo-1512486130939-2c4f79935e4f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    description: "Biblioteca de componentes UI reutilizáveis com foco em acessibilidade e personalização.",
  ...
  },
  {
    ...
    description: "Site para fotógrafo profissional com galeria de imagens, blog e formulário de contato.",
  ...
  },
  {
    ...
    description: "Extensão para VS Code que automatiza tarefas comuns de desenvolvimento front-end.",
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-xl opacity-90 max-w-2xl">
              Uma seleção dos meus projetos mais recentes e relevantes no campo do desenvolvimento front-end.
            </p>
          </motion.div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        {featuredProjects.length > 0 && (
          <section className="mb-16">
            <h2 className="text-2xl font-bold mb-8 dark:text-white">Projetos em Destaque</h2>
                        ...
                        <div className="p-6 w-full">
                          <div className="flex justify-between items-center">
                            ...
                            <div className="flex space-x-2">
                              {project.githubUrl && (
                                <Button variant="outline" size="icon" asChild className="bg-white/20 border-0 hover:bg-white/30">
                    ...
                    <CardContent>
                      <div className="flex flex-wrap gap-2">
                        {project.tags.map((tag, index) => (
                          <Badge key={index} variant="outline" className="dark:text-gray-300 dark:border-gray-700">
                            {tag}
                          </Badge>
                        ))}
                      </div>
        ...
        <section>
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold dark:text-white">Todos os Projetos</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProjects.map((project) => (
              <motion.div
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.3, delay: 0.1 * (filteredProjects.indexOf(project) % 6) }}
              >
        ...
        <section className="mt-20 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-lg p-8 text-white">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Interessado em trabalhar juntos?</h2>
            <p className="text-lg opacity-90 mb-8">
              Estou sempre aberto a novas oportunidades e parcerias. Entre em contato para discutirmos seu projeto!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="secondary" size="lg" asChild>
                <Link to="/blog/contato">
                  Entre em contato
                </Link>
              </Button>
